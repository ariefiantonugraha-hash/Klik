const uiCopy = {
  en: {
    ...
    navStart: "Join early access",
    eyebrow: "Klik early access flow",
    ...
    profileCopy:
      "Early access keeps it simple. Pick Child for a parent-guided view, or Teen for a self-understanding view.",
    childPill: "Child",
    ...
    profileHelper:
      "This early access includes 10 simple questions and a short result snapshot.",
    continue: "Continue",
  ...
  id: {
    ...
    navWho: "Untuk siapa",
    navHow: "Cara kerja",
    navAssessment: "Asesmen",
    navStart: "Mulai akses awal",
    eyebrow: "Alur akses awal Klik",
    ...
    profileCopy:
      "Versi akses awal ini dibuat tetap sederhana. Pilih Child untuk sudut pandang orang tua, atau Teen untuk sudut pandang pemahaman diri.",
    childPill: "Child",
    ...
    profileHelper:
      "Akses awal ini berisi 10 pertanyaan sederhana dan ringkasan hasil singkat.",
    continue: "Lanjut",
...
const elements = {
  navDiscover: document.querySelector('a[data-i18n="nav.discover"]'),
  navWho: document.querySelector('a[data-i18n="nav.who"]'),
  navHow: document.querySelector('a[data-i18n="nav.how"]'),
  navAssessment: document.querySelector('a[data-i18n="nav.assessment"]'),
  ...
  navBackdrop: document.getElementById("assessmentNavBackdrop")
};
...
function renderStaticCopy() {
  ...
  elements.navDiscover.textContent = copy.navDiscover;
  elements.navWho.textContent = copy.navWho;
  elements.navHow.textContent = copy.navHow;
  elements.navAssessment.textContent = copy.navAssessment;
  elements.homeLink.textContent = copy.navStart;
...
if (elements.navToggle && elements.navPanel) {
  ...
  elements.navToggle.addEventListener("click", () => {
    ...
    elements.navBackdrop?.classList.add("is-open");
    elements.navPanel.scrollTop = 0;
  });
  ...
  window.addEventListener("resize", () => {
    ...
    if (window.innerWidth > 860 && elements.navToggle.getAttribute("aria-expanded") === "true") {
      closeMenu();
    }
  });
}
